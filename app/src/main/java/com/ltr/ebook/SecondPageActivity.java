...
import com.ltr.ebook.databinding.ActivitySecondPageBinding;
...
public class SecondPageActivity extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SecondAdapter adapter1 = new SecondAdapter(bookList, false, this);
    ...
    public void initList() {
        bookList.add(new Book("c9dd3342-899a-3142-9acd-925a35667ba2",
                "剑来",
                "烽火戏诸侯",
                "武侠仙侠",
        ...
        bookList.add(new Book("5b7c44af-3a86-331e-af6c-cbf008d4395d",
                "神秘复苏",
                "佛前献花",
                "修真小说",
        ...
        bookList.add(new Book("8cf9eb04-4cd1-39db-a979-fb2c06e0bdc0",
                "万相之王",
                "天蚕土豆",
                "玄幻小说",
                "天蚕土豆新书",
        ...
        bookList.add(new Book("81cf0f7e-ad65-3c6e-9dd7-ec1eac5b6764",
                "宠魅",
                "鱼的天空",
                "玄幻小说",
        ...
        bookList.add(new Book("53090331-b8d2-383e-8d37-9219b4fa43b3",
                "三体（全集）",
                "刘慈欣",
                "科幻灵异",
        ...
        bookList.add(new Book("453e8e2f-b7fe-354c-90c6-b31ab7aeb3cd",
                "龙族",
                "江南",
                "玄幻奇幻",
